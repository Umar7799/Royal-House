...
const SmallFilter = ({ setOpenSmallFilter, openSmallFilter }) => {
	...
	return (
		<>
			...
			<div className="flex items-center justify-between py-4">
				<h1>Filterlash</h1>
				<h1 onClick={() => setOpenSmallFilter(!openSmallFilter)} className="cursor-pointer border border-black px-2 rounded-xl">X</h1>
			</div>
			...
			<div className="rounded-xl">
				...
				<div className="border border-neutral-200">
					<button
						className={`${activeElement === "Collection" && ``} group relative flex w-full items-center bg-white px-5 py-2 hover:z-[2] focus:z-[3] focus:outline-none`}
					...
					<TECollapse show={activeElement === "Collection"} className="!mt-0 !rounded-b-none !shadow-none text-base transition-all duration-500">
			...
			<div>
				<div className="border border-neutral-200">
					...
					<TECollapse show={activeElement === "Stillar"} className="!mt-0 !rounded-b-none !shadow-none text-base transition-all duration-500">
						<div className="px-5 py-4">
			...
			<div>
				<div className="border border-neutral-200">
					...
					<TECollapse show={activeElement === "Xonalar"} className="!mt-0 !rounded-b-none !shadow-none text-base transition-all duration-500">
						<div className="px-5 py-4">
			...
			<div>
				<div className="border border-neutral-200">
					...
					<TECollapse show={activeElement === "Shakl"} className="!mt-0 !rounded-b-none !shadow-none text-base transition-all duration-500">
						<div className="px-5 py-4">
			...
			<div>
				<div className="border border-neutral-200">
					...
					<TECollapse show={activeElement === "Rang"} className="!mt-0 !rounded-b-none !shadow-none text-base transition-all duration-500">
						<div className="px-5 py-4">
							{/* BLACK */}
			...
			<div className="bg-white pb-4 flex text-base justify-center items-center space-x-4 pt-2 rounded-b-xl">
