...
const AffordableProducts = () => {
	...
	return (
		<div className='flex justify-center bg-gradient-to-r from-[#F7F8F8] to-[#ACBB78] py-10'>
			<section className='w-[90vw] px-1 pb-8'>
				<div className='flex justify-between px-4 mb-8 items-center transition-all duration-500'>
					<h1 className='text-2xl sm:text-3xl lg:text-4xl font-bold'>Ommabop to'plamlar</h1>
